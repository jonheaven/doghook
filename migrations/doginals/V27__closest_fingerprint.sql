-- closest_fingerprint resolution mode for DogeLotto variants (doge-69-420, doge-4-20-flash, doge-max)
--
...
-- dogelotto_tickets: pre-computed fingerprint + derived classic lottery numbers
ALTER TABLE dogelotto_tickets
    ADD COLUMN IF NOT EXISTS fingerprint     TEXT,
    ADD COLUMN IF NOT EXISTS classic_numbers INTEGER[] NOT NULL DEFAULT ARRAY[]::INTEGER[];

-- dogelotto_lotteries: block-hash-as-u256 target + 6 classic numbers drawn at resolution
...
-- dogelotto_winners: distance stored as hex u256, plus classic-tier match data
